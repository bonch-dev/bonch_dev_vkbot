...
type User struct {
	...
	VKID       null.Int    `boil:"vk_id" json:"vk_id,omitempty" toml:"vk_id" yaml:"vk_id,omitempty"`
	VKDomain   null.String `boil:"vk_domain" json:"vk_domain,omitempty" toml:"vk_domain" yaml:"vk_domain,omitempty"`
	State      null.String `boil:"state" json:"state,omitempty" toml:"state" yaml:"state,omitempty"`
	TestPhase  null.Int    `boil:"test_phase" json:"test_phase,omitempty" toml:"test_phase" yaml:"test_phase,omitempty"`
	TestPoints null.Int    `boil:"test_points" json:"test_points,omitempty" toml:"test_points" yaml:"test_points,omitempty"`
...
var UserWhere = struct {
	ID         whereHelperint
	VKID       whereHelpernull_Int
	VKDomain   whereHelpernull_String
	State      whereHelpernull_String
	TestPhase  whereHelpernull_Int
	TestPoints whereHelpernull_Int
}{
	ID:         whereHelperint{field: "`users`.`id`"},
	VKID:       whereHelpernull_Int{field: "`users`.`vk_id`"},
	VKDomain:   whereHelpernull_String{field: "`users`.`vk_domain`"},
	State:      whereHelpernull_String{field: "`users`.`state`"},
	TestPhase:  whereHelpernull_Int{field: "`users`.`test_phase`"},
	TestPoints: whereHelpernull_Int{field: "`users`.`test_points`"},
}
...
var (
	userAllColumns            = []string{"id", "vk_id", "vk_domain", "state", "test_phase", "test_points"}
	userColumnsWithoutDefault = []string{"vk_id", "vk_domain", "state", "test_phase", "test_points"}
